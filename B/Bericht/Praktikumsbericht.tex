...
\begin{document}
	...
	\end{figure}
	In beiden Diagrammen lässt sich die gleiche Tendenz erkennen. Die Verfahren \textit{dynamic} und \textit{static} sind etwa gleichauf erzielen eine schnellere Ausführungszeit. Der geringe Unterschied der beiden lässt sich, wie eingangs beschrieben, damit begründen, dass alle Threads auf einem Socket ausgeführt werden.
	...
	\begin{table}
		\begin{center}
			\begin{tabular}{||c c c c c c c||}
				...
				\hline\hline
				ICC      & guided   & 128  & 32        & 1 000 000   & 3                   & 5                \\
				\hline
				ICC      & auto     & 128  & 32        & 1 000 000   & 3                   & 5                \\
				\hline
				ICC      & dynamic  & 128  & 32        & 1 000 000   & 3                   & 5                \\
				\hline
				ICC      & static   & 128  & 32        & 1 000 000   & 3                   & 5                \\
				\hline
			\end{tabular}
			\caption{\label{tab:icc}Testergebnisse der verschiedenen Scheduling-Verfahren. Zeiten gerundet auf vier Stellen.}
		\end{center}
	\end{table}
	\clearpage
