...
\end{lstlisting}
	...
	\end{figure}
	Betrachtet man die Werte zwischen der Version seriellen und der SIMD parallelen Version, fällt ein deutlicher Speedup von etwa 9 (bei Feldgröße 32768) auf. Diese Parallelisierung war folglich sehr effektiv.\\
